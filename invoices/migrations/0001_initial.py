# Generated by Django 3.2.12 on 2025-12-03 22:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_item_line_total', models.DecimalField(decimal_places=2, max_digits=12)),
                ('invoice_item_created_at', models.DateTimeField(auto_now_add=True)),
                ('invoice_item_updated_at', models.DateTimeField(auto_now=True)),
                ('invoice_item_diagnose_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='invoices.diagnose')),
